...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="absolute top-0 z-[1000] w-full left-1/2 -translate-x-1/2 flex items-center justify-center bg-white" style={{ height: '62px' }}>
          ...
          >
            {items.map((item, i) => {
              ...
              const basePillClasses =
                'relative overflow-hidden inline-flex items-center justify-center h-full no-underline rounded-full box-border font-semibold text-[20px] leading-[0] uppercase tracking-[0.2px] whitespace-nowrap cursor-pointer px-0';
              ...
              return (
                ...
                >
                  ...
                  {hasDropdown && openDropdown === i && (
                    <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg py-2 min-w-[150px] z-[1001]">
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden absolute top-[3em] left-4 right-4 rounded-[27px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] z-[998] origin-top backdrop-blur-sm"
        style={{
          ...cssVars,
